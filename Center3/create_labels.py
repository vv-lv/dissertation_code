...
def create_labels_file(features_csv_path, output_label_path, base_data_path):
    ...
    for file_identifier in ids:
        ...
        # 搜索NoPAS和PAS目录
        no_pas_match = (
            glob.glob(os.path.join('/home/vipuser/Desktop/Data/PASRawData/center3/NoPAS', file_identifier + '*.nii.gz'))
        )
        
        pas_match = (
            glob.glob(os.path.join('/home/vipuser/Desktop/Data/PASRawData/center3/PAS', file_identifier + '*.nii.gz')) 
        )
...
if __name__ == "__main__":
    # 特征文件路径
    test_features_path = "/home/vipuser/Desktop/Data/Task02_PASp62_radiomics/test_features_3.csv"
