...
def ensemble_cv_models_on_test(exp_dir, test_dataset, hp):
    ...
    with torch.no_grad():
        for images, labels in tqdm(test_loader, desc="评估集成模型"):
            images = images.to(device)
            labels = labels.to(device).unsqueeze(1).float()
            all_labels.extend(labels.cpu().numpy().flatten().tolist())
...
if __name__ == "__main__":
    ...
    cross_validate(
        ...
        # only_test_dataset='/home/vipuser/Desktop/bigdata/MyProject/results/resnet18_20250404_084156'
        # only_test_dataset='/home/vipuser/Desktop/MyProject/results/global/resnet18_20250321_043843_SingeBranch'
    )
