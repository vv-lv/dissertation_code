...
from dataset_global import MRIDataset3D
...
def multi_train_with_ensemble(train_dataset, test_dataset, hp, exp_dir, num_runs=3, 
    ...
    optimal_idx = np.argmax(youden_index)
    optimal_threshold = thresholds[optimal_idx]
    # optimal_threshold = 0.6816  # ParallelBranch: 0.5795~0.7438
    # optimal_threshold = 0.4924  # ParallelBranch: 0.4528~0.4921
...
if __name__ == "__main__":
    ...
    # =========================
    # 排序文件名
    test_image_filenames = sorted(os.listdir(os.path.join(base_path, 'imagesTs_3')))
    test_label_filenames = sorted(os.listdir(os.path.join(base_path, 'labelsTs_3')))
    
    # 构建路径
    test_image_paths = [
        os.path.join(base_path, 'imagesTs_3', file) for file in test_image_filenames
    ]
    test_label_paths = [
        os.path.join(base_path, 'labelsTs_3', file) for file in test_label_filenames
    ]
    ...
    for label_file in test_label_filenames:
        ...
        no_pas_match = glob.glob(
            os.path.join('/home/vipuser/Desktop/Data/PASRawData/center3/NoPAS', file_identifier + '*.nii.gz')
        ) or glob.glob(
            os.path.join('/home/vipuser/Desktop/Data/PASRawData/center3/NoPAS', file_identifier + '*.nii.gz')
        )
        pas_match = glob.glob(
            os.path.join('/home/vipuser/Desktop/Data/PASRawData/center3/PAS', file_identifier + '*.nii.gz')
        ) or glob.glob(
            os.path.join('/home/vipuser/Desktop/Data/PASRawData/center3/PAS', file_identifier + '*.nii.gz')
        )
    ...
    cross_validate(
        ...
        # only_test_dataset='/home/vipuser/Desktop/test_new_file/global/resnet18_20250404_084156'
        # only_test_dataset='/home/vipuser/Desktop/test_new_file/global/resnet18_20250404_055529_SingleBranch'
        # only_test_dataset='/home/vipuser/Desktop/test_new_file1/global/resnet18_20250424_012017'
        # only_test_dataset='/home/vipuser/Desktop/test_new_file1/global/resnet18_20250424_062753_SingleBranch'
        # only_test_dataset='/home/vipuser/Desktop/test_new_file2/global/resnet18_20250425_152119'
        only_test_dataset='/home/vipuser/Desktop/test_new_file2/global/resnet18_20250425_224506_SingleBranch'
    )
