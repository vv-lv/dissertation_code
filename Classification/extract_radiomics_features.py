...
def main():
    ...
    labelsTs_dir = os.path.join(base_dir, "labelsTs")
    
    # 预处理后的输出目录
    processed_imagesTr_dir = os.path.join(output_dir, "imagesTr")
    processed_labelsTr_dir = os.path.join(output_dir, "labelsTr")
    processed_imagesTs_dir = os.path.join(output_dir, "imagesTs")
    processed_labelsTs_dir = os.path.join(output_dir, "labelsTs")
