...
def main():
    """主函数"""
    # --- Same config and loading logic as before ---
    config = {
        'test_features_path': '/home/vipuser/Desktop/Data/Task02_PASp62_radiomics/RD/final_test_features_3.csv',
        'test_labels_path': '/home/vipuser/Desktop/Data/Task02_PASp62_radiomics/test_labels_3.csv',
        'results_dir': '/home/vipuser/Desktop/Classification/test_results_RD_3_combined_threshold', # Changed dir name slightly
        'models_dir': '/home/vipuser/Desktop/Classification/train_results_RD',
    ...
    for model_type in config['models_to_test']:
        ...
        if os.path.exists(model_path) and os.path.exists(scaler_path):
            try:
                # Pass threshold_path to load_model, it will handle default if not found
                model, scaler, loaded_threshold = load_model(model_path, scaler_path, threshold_path)
                models_info[model_type] = {
                    'model': model,
                    'scaler': scaler,
                    'threshold': loaded_threshold # Store the initially loaded threshold
                }
            except Exception as e:
    ...
    test_results = None
    if models_info:
        # Call the modified test_models function
...
def main():
    ...
    config = {
        'test_features_path': '/home/vipuser/Desktop/Data/Task02_PASp62_radiomics/RD/final_test_features_3.csv',
        'test_labels_path': '/home/vipuser/Desktop/Data/Task02_PASp62_radiomics/test_labels_3.csv',
        'results_dir': '/home/vipuser/Desktop/Classification/test_results_RD_3',
